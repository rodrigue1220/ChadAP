...
*/
	...
	$sql2 = "INSERT INTO wfp_chd_sandoukvar (vars_id, vars_ref, vars_item, vars_nbr, vars_sens, vars_date, vars_type)
			VALUES ('', '$refer', '$code', '$nbr', '$es', '$date', 'FOURN')";
	...
	{
		echo'Echec Ajout <br><br><center><a href="stockaddsortfourn.php">retour</a></center>' ;
	}	  
?>
