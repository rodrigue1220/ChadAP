...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-book-open"></i> Demande de fourniture (s)</h1>
	</div>
	<hr />   
	...
	<div class="row">
     <div class="col-lg-6">
      <form name="formulaire" action="askfour2.php" method="post" onsubmit="return verif_formulaire()" >
	...
	<?php 
		...
		if($exist['ID'] != 0)
		{
			...
			echo("<div class=\"card shadow mb-4\">
					<a href=\"#collapseReqSTDBY\" class=\"d-block card-header py-3\" data-toggle=\"collapse\" role=\"button\" aria-expanded=\"true\" aria-controls=\"collapseReqSTDBY\">
		    		  <h6 class=\"m-0 font-weight-bold text-primary\">Vous avez de (s) Demande (s) en attente de soumission</h6>
					</a>
					<div class=\"collapse no-show\" id=\"collapseReqSTDBY\">
						<div class=\"card-body\">");
			...
			echo("</tbody></table>");
			echo("<hr /><center><a href=\"askfourconform.php?cle=".$ref."\" class=\"d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm\"><i class=\"fas fa-check fa-sm text-black-75\"></i> Soumettre</a></center>");
			echo("</div>
			</div>
		  </div>");
		echo("</div></div>
  ...
  <!-- End of Page Wrapper -->
	...
	<div class="modal fade fond" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-footer">
		<a href="askfour.php" class="btn btn-danger" id="confirmModalNo">Non</a>
