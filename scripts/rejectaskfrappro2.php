<?php
	...
	if ($profil != "AdminFOURN")
	{
		...
		$sql = "UPDATE wfp_chd_requesteqpmt SET rqeqpmt_state='REJET3', rqeqpmt_dappro='$date', rqeqpmt_lib2='$comm'
				WHERE rqeqpmt_id='$id'";
		...
		if( $requete )
		{
			...
			include("inc/rissalarejaskfrappro.php");
			header('Location:listdemfourn.php') ;
		}
