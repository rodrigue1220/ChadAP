...
*/
	...
	else 
	{
		$sql2 = "INSERT INTO wfp_chd_requesteqpmtvar (rqeqv_id, rqeqv_ref, rqeqv_item, rqeqv_nbr, rqeqv_dem, rqeqv_date, rqeqv_state, rqeqv_type)
			VALUES ('', '$refer', '$code', '$nbr', '$demandeur', '$date', 'STDBY', '')";
		...
		{
			echo("<span class=\"alert alert-danger\">Echec Ajout <br><br><center><a href=\"askeqpmform.php?cle=IT\">retour</a></center></span>") ;
		}
	}	
?>
