				...
				while( $result = $requete->fetch_assoc()  )
				{
					...
					echo("<table class=\"table table-striped table-bordered table-hover\">
						<tbody>
							...
							<tr><th>Date de Reprise</th><td>".$result['lv_rep']."</td></tr>
						</tbody>");
					echo("</table>");
					echo(" <button type=\"button\" class=\"btn btn-success\" onclick=\"document.location='validjoummahft.php?id=".$result['lv_id']."'\" title=\"Confirmer la Demande\"><i class=\"fa fa-check-circle\" fa-fw></i> CONFIRMER</button>
