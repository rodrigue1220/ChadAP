                ...
                <div class="col-lg-12">
					<h1 class="page-header">
						<div align="right"><style type="text/css"> .btn{ width:200px; } </style>
							...
							<button type="button" class="btn btn-success" onclick="document.location='#'" title="Créer profil employé"><i class="fa fa-user" fa-fw></i> Profils</button>
							<button type="button" class="btn btn-warning" onclick="document.location='#'" title="Enregistrer jour férié"><i class="fa fa-calendar" fa-fw></i> Jours F&eacute;ri&eacute;s</button>
						</div><br />
