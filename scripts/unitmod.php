...
<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-edit"></i> Changer Unit&eacute;</h1>
	...
	<div class="row">
      <div class="col-lg-8">
	    <form class="form-horizontal" name="formulaire" action="unitmod2.php" method="post" onsubmit="return verif_formulaire()" >
		  ...
		  <div class="form-group row">
		   ...
		   <div class="form-group row">
			<div class="col-sm-offset-2 col-sm-12">
			  <button type="submit" class="btn btn3 btn-success"><i class="fa fa-exchange fa-fw"></i> Changer</button>
