...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fa fa-building fa-fw"></i> Salle de R&eacute;union</h1>
	<hr />
	<div class="row">
	  <div class="col-lg-12">
        <form class="form-horizontal" name="formulaire" action="add2sdr.php" method="post" >
		  <div class="form-group row">
			<label class="control-label col-sm-3" for="sal">Salle :</label>
			<div class="col-sm-5">
			  <input type="text" id="sal" name="sal" placeholder="Entrer le nom" class="form-control"/>
			</div>
		  </div>
