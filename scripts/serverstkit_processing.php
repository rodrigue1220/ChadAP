...
$table = <<<EOT
 (
	SELECT j.stock_id, j.stock_item, j.stock_nbr, j.stock_remarks, j.stock_cat, p.catart_code, p.catart_nom, p.catart_lib
...
$columns = array(
    ...
    array( 'db' => 'stock_nbr', 'dt' => 4 ),
    array( 'db' => 'stock_remarks', 'dt' => 5 )
);
