...
$wakit	= date("dmY");
$sql = "SELECT j.cto_id, j.cto_index, j.cto_deb, j.cto_hdeb, j.cto_hfin, j.cto_deb2, j.cto_hdeb2, j.cto_hfin2, j.cto_choix, j.cto_raison, j.cto_approver, j.cto_dapprover, j.cto_dapprover2, j.cto_dure, j.cto_statut,  p.rh_lname, p.rh_fname
...
while ($ligneencours = $requete->fetch_assoc()) //Tant qu'il y a un enregistrement dans la table on l'associe à une ligne du tableau
{
    ...
    $export[] = array($ligneencours["cto_index"], $ligneencours["rh_lname"], $ligneencours["rh_fname"], $ligneencours["cto_deb"], $ligneencours["cto_hdeb"], $ligneencours["cto_hfin"], $ligneencours["cto_deb2"], 
	$ligneencours["cto_hdeb2"], $ligneencours["cto_hfin2"], $ligneencours["cto_choix"], $ligneencours["cto_raison"], $ligneencours["cto_dure"], 
	$ligneencours["cto_dapprover"], $ligneencours["cto_dapprover2"], $ligneencours["cto_statut"]);
}
 
    // Nom du fichier et delimiteur entre chaque entrées
    $chemin = "WFP_Chad-RecapHSUPP-".$pseudo."_".$wakit.".csv";
    ...
    */
    ...
    $entetes = array('Index', 'Nom', 'Prénom', 'Date 1', 'Heure D1', 'Heure F1', 'Date 2', 'Heure D2', 'Heure F2', 'Choix', 'Raison', 'Durée', 'Date Appro.', 'Date Certif.', 'Statut');
