  ...
  <script type="text/javascript">
	$(document).ready(function() {
		$('#example2').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serveraskrej_processing.php",
			"language": {
...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-thumbs-down fa-fw"></i> Mes Demandes Rejet&eacute;es / Annul&eacute;es</h1>
	</div> 
	<hr />   
	...
	<div class="row-lg-auto">
		...
		<?php
			...
			$i=1;
			$exis = $mysqli->query("SELECT reqsdr_id AS ID FROM wfp_chd_requestsdr WHERE reqsdr_deman='$pseudo' AND reqsdr_state='REJET'")->fetch_array();
						
			if($exis['ID'] != 0)
			{
				$sql = "SELECT * FROM wfp_chd_requestsdr WHERE reqsdr_deman='$pseudo' AND reqsdr_state='REJET' " ;
			...
			{
				echo("<div class=\"alert alert-danger\">Vous n'avez aucune demande de SDR rejet&eacute;e...</div>") ;		
			}
		?>
		</tbody></table>
            </div>
