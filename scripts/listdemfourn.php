...
<link href="inc/iz-modal.css" rel="stylesheet" type="text/css" />  
  <style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list fa-fw"></i> Demande de fourniture (s) </h1>
	  ...
	  <a href="stockaddsortfourn.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-secondary shadow-sm"><i class="fa fa-exchange fa-sm text-white-75"></i> E/S du Stock</a>
	</div>
	<hr />   
	  ...
	  <div class="col-lg-auto">
		<div class="card shadow mb-4">
		  <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Liste des demandes de fourniture | <font color="#FF0000"> approuv&eacute;es par OIC / ADMIN</font></h6>
		  </div>
		  <div class="card-body">
			...
			<?php
				...
				if($exis['ID'] != 0)
				{
					...
					while( $result3 = $requete->fetch_assoc()  )
					{
						...
						echo("<td><a href=\"listdemfourndet.php?id=".$result3['rqeqpmt_ref']."\" class=\"btn btn-info btn-circle btn-sm\" title=\"DETAILLER LA DEMANDE\"><i class=\"fas fa-list text-white\"></i></a></td>");
				...
				{
					echo("<div class=\"alert alert-danger\">Aucune demande de fourniture approuv&eacute;e par OIC / ADMIN...</div>") ;		
				}
			?>
		</div>
	  </div>
