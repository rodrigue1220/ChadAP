      ...
      <div class="col-lg-12">
        <form class="form-horizontal" name="formulaire" action="cargoassign2.php" method="post">
		  ...
		  <div class="form-group row">
			...
			<div class="col-sm-4">
			  <input type="number" step="0.01" id="tonnch" name="tonnch" class="form-control" placeholder="Tonnage &agrave; charger" />			
			</div>

			<label class="control-label col-sm-2" for="volch">Volume :</label>
			<div class="col-sm-4">
			  <input type="number" step="0.01" id="volch" name="volch" class="form-control" placeholder="Volume &agrave; charger"/>			
			</div>
		  </div>
