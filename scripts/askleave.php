...
<head>
  ...
  <link href="http://10.109.87.10:8080/css/iz-admin-2.min.css" rel="stylesheet" type="text/css" />
  ...
  <script type="text/javascript" src="http://10.109.87.10:8080/scripts/js/saa.js"></script>
  <link rel="stylesheet" type="text/css" href="http://10.109.87.10:8080/scripts/DataTables/media/css/jquery.dataTables.min.css" />
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-list"></i> <i class="fas fa-fw fa-calendar"></i> Liste des demandes de Cong&eacute;s</h1>
				<a href="rapdjmrh.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-warning shadow-sm"><i class="fa fa-reply fa-sm text-black-75"></i> Annuler Demande</a>
				<a href="trtdjmrh.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-success shadow-sm"><i class="fas fa-hourglass-1 fa-sm text-black-75"></i> Traiter Demandes</a>
		...
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Liste des demandes de Cong&eacute;s All Staff</h6>			
          </div>
  ...
  <script type="text/javascript" src="http://10.109.87.10:8080/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script type="text/javascript" src="http://10.109.87.10:8080/scripts/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script type="text/javascript" src="http://10.109.87.10:8080/vendor/datatables/jquery.dataTables.min.js"></script>
  <script type="text/javascript" src="http://10.109.87.10:8080/vendor/datatables/dataTables.bootstrap4.min.js"></script>
