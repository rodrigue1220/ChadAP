...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-exchange fa-fw"></i> E/S du Stock </h1>
	  ...
	  <a href="gestartfourn.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-info shadow-sm"><i class="fas fa-list fa-sm text-black-75"></i> Liste des Articles</a>				
    </div>
	<hr />  

	<div class="row">
	  <div class="col-lg-12">
        <form class="form-horizontal" name="formulaire" action="stockaddsortfourn2.php" method="post" onsubmit="return verif_formulaire()" >
