...
<script type="text/javascript">
		...
		{
			if(document.formulaire.oic.value == "Approuvé par...")  {
...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
	  ...
	  <a href="askeqpmform.php?cle=IT" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-list fa-sm text-black-75"></i> Demande (s)</a>				
    </div>
	<hr />   
    ...
    <div class="row">
	 <div class="col-lg-6">
      <form name="formulaire" action="askfour3.php" method="post" onsubmit="return verif_formulaire()" >
		...
		<div class="form-group row">
		  <label class="control-label col-sm-4" for="oic">OIC :</label>
		  <div class="col-sm-8">
			<select class="form-control" id="oic" name="oic" required>
			  <option>Approuvé par...</option>
			  <?php	
