		...
		<!-- Tables -->
          <div class="card shadow mb-6">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success"><i class="fas fa-plus fa-fw"></i> Ajouter In Transit</h6>
            </div>
            <div class="card-body">
             
                <table class="table table-bordered" >
				  
				  <form class="form-horizontal" name="formulaire" action="addlogtrz.php" method="post" >
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="orig">Origine :</label>
					  <div class="col-sm-9">
						<select class="form-control" id="orig" name="orig" required >
						  <?php
							$sqlb 	= "SELECT DISTINCT logc_nom FROM wfp_chd_logconf WHERE logc_type='ORIG' " ;
					...
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="wh">Destination :</label>
					  <div class="col-sm-9">
					...
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="cdesc">Comm. Desc. :</label>
					  <div class="col-sm-9">
					...
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="bbd">BBD :</label>
					  <div class="col-sm-9">
          ...
          <div class="card shadow mb-6">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" >
				  ...
				  <form class="form-horizontal" name="formulaire" action="rechlogtrzreport.php" method="get" onsubmit="return verif_formulaire()" >
					<div class="form-group row">
					  <label class="control-label col-sm-3" for="pwh">Par WH:</label>
					  <div class="col-sm-9">
						<select class="form-control" id="pwh" name="pwh" required >
						<option></option>
						  <?php
							$sqlb 	= "SELECT DISTINCT logc_nom FROM wfp_chd_logconf WHERE logc_type='WH' " ;
							$requeteb = $mysqli->query( $sqlb ) ;
