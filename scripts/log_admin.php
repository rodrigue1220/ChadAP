...
if(isset($_GET['erreur']))
	...
	if($erreur=="pseudo")
		{
		echo"<b><font size=\"+2\" color=\"#ffffff\">Erreur : Votre pseudo est invalide</font></b>";
		}
	if($erreur=="passe")
		{
		echo"<b><font size=\"+2\" color=\"#ffffff\">Erreur : Votre mot de passe est invalide</font></b>";
		}
	if($erreur=="connexion")
		{
		echo"<b><font size=\"+2\" color=\"#ffffff\">Erreur : Vos identifiants de connexion sont incorrects OU compte INACTIF</font></b>";
		}
	if($erreur=="state")
		{
		echo"<b><font size=\"+2\" color=\"#ffffff\">Erreur : Ce compte est INACTIF</font></b>";
		}
	echo'</span>';
	}
