      ...
      <div id="content">
		...
		<!-- Page Heading -->
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"> Stock Disponible</h1>
	  <!--a href="stockvar.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-warning shadow-sm"><i class="fa fa-sign-in fa-sm text-black-75"></i> Variations Stock <i class="fa fa-sign-out fa-sm text-white-75"></i> </a>				
      <a href="stockadd.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-primary shadow-sm"><i class="fa fa-sign-in fa-sm text-white-75"></i> Entr&eacute;es</a>				
      <a href="stocksort.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-info shadow-sm"><i class="fa fa-sign-out fa-sm text-white-75"></i> Sorties</a>				
      <a href="listdeqpmt.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-success shadow-sm"><i class="fa fa-list fa-sm text-white-75"></i> Demandes</a-->				     
	</div>
	<hr />   
