	...
	<div class="row">
	  <div class="col-lg-12">
		<div class="card shadow mb-4">
		  ...
		  <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fa fa-download fa-sm text-black-75"></i> T&eacute;l&eacute;charger la liste au <b><?php echo date("d.m.Y"); ?></b> <i class="fa fa-download fa-sm text-black-75"></i></a>								     
