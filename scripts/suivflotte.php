  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 5,
			"ajax": "serverstfl_processing.php",
			"language": {
...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-sliders"></i> Situation des Camions </h1>
		...
		<?php 
			...
			//{
				echo ("<a href=\"cargotrack.php\" class=\"d-none d-sm-inline-block btn btn3 btn-sm btn-success shadow-sm\"><i class=\"fas fa-cogs fa-sm text-white-75\"></i> Gest. Tracking</a>");
			//}
		?>				
	</div> 
	<hr />   
	...
	<div class="row-auto">
		...
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-list"></i>  Liste des Camions</h6>
          </div>
