...
<link href="inc/iz-modal.css" rel="stylesheet" type="text/css" />  
  <style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list-alt fa-fw"></i> D&eacute;tails Demande en attente | OIC / Admin</h1>
	  <a href="listdefourn.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-list fa-sm text-black-75"></i> Demande (s) en Attente | OIC / Admin</a>
	</div>
	<hr />   
	  ...
	  <div class="col-lg-auto">
		<div class="card shadow mb-4">
		  <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Liste des articles de la demande <font color="#FF0000"><?php echo $id; ?> | en attente de v&eacute;rification</font></h6>
		  </div>
		  <div class="card-body">
			...
			<?php
				...
				if($exis['ID'] != 0)
				{
					...
					while( $result = $requete->fetch_assoc()  )
					{
						...
						echo("<td><a href=\"askfouradmrej.php?id=".$result['rqeqv_id']."&ref=".$result['rqeqv_ref']."\" data-toggle=\"modal\" data-target=\"#confirmModal\" class=\"confirmModalLink btn btn-danger btn-circle btn-sm\" title=\"REJETER\"><i class=\"fa fa-reply text-white\"></i></a></td>");
					}
					echo("</tr></tbody></table>");
					echo("<hr /><center><a href=\"askfouradmapprvall.php?ref=".$id."\" data-toggle=\"modal\" data-target=\"#confirmModal\" class=\"confirmModalLink btn btn3 btn-info\"><i class=\"fas fa-check fa-sm text-white\"></i><i class=\"fas fa-check fa-sm text-white\"></i> Tout Approuver</a></center>");
				}
				else
				{
  ...
  <!-- End of Page Wrapper -->
	...
	<div class="modal fade fond" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-footer">
		<?php echo("<a href=\"listdefourndet.php?id=".$id."\" class=\"btn btn-danger\" id=\"confirmModalNo\">Non</a>"); ?>
