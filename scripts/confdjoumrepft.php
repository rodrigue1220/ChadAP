<?php
	...
	if ($choix=="OUI")
	{
		$sql3 = "UPDATE wfp_chd_djoummah SET leave_ldate='$repriz', leave_solde='0' WHERE leave_nopers='$nopers' AND leave_type='$type' ";			
		...
		if( $requete3 )
		{
			...
			include("inc/rissalacaskdjmft.php");
			header('Location:simple.php') ;
		}
		else
		{
			echo("<span class=\"alert alert-danger\">Echec Confirmation Reprise<br><br><center><a href=\"djoummahaskconft.php\">retour</a></center></span>") ;
		}
	}
	/*else
	{
