...
*/
	...
	if($nb['nb']!=0)
	{		
		header('Location:oops666khalatt.php?cle=QITADD');
		exit();
	}
	...
	else 
	{
		$sql2 = "INSERT INTO wfp_chd_catart (catart_id, catart_code, catart_nom, catart_type, catart_desc, catart_lib, catart_seuil)
			VALUES ('', '$code', '$item', 'ART', '$desc', '$cat', '$seuil')";
		...
		{	
			...
			header('Location:articaddit.php');
		}
			
		else
		{
			echo'Echec Ajout <br><br><center><a href="articaddit.php">retour</a></center>' ;
		}
	}		
