  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverecto_processing.php",
			"language": {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fa fa-fw fa-table"></i> R&eacute;capitulatif CTO</h1>
				<a href="askcto.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-info shadow-sm"><i class="fas fa-list fa-sm text-black-75"></i> Demandes CTO</a>
		</div> 
		<hr />
      ...
      <div class="col-lg-auto">
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Liste R&eacute;capitulative des demandes Heures Supp. All Staff</h6>			
          </div>
		  ...
		  <?php
			...
			{
				$mois	= date('Y-m', strtotime('-2 month'));
			}
			
			include("exportrecapcto.php");
			echo("<a href=\"Recap_Demandes_CTO-".$mois.".csv\" class=\"d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm\"><i class=\"fa fa-download fa-sm text-black-75\"></i> T&eacute;l&eacute;charger RECAP CTO en CSV | <b>".$mois."</b> <i class=\"fa fa-download fa-sm text-black-75\"></i></a>");
		  ?>
