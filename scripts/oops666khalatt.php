...
*/
	...
	$cle	= $_GET["cle"];
	$sql	= "SELECT * FROM wfp_chd_khalatt WHERE err_code='$cle' ";	
...
<head>
  ...
  <?php echo("<meta http-equiv=\"refresh\" content=\"4; URL=$lien\" />"); ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  <center>
			<img src="../img/oops.jpg" alt="Erreur">
			<br /><br /><div class="alert alert-danger"><strong><?php echo $desc;?></strong></div>
		  </center>
		</div>
        <!-- /.container-fluid -->	
      </div>
