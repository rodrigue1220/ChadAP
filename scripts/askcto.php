  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serveraskcto_processing.php",
			"language": {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-list"></i> <i class="fas fa-fw fa-hourglass-1"></i> Liste des demandes CTO</h1>
				<a href="recapcto.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-info shadow-sm"><i class="fas fa-table fa-sm text-black-75"></i> R&eacute;cap CTO</a>
				<a href="rapctorh.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-warning shadow-sm"><i class="fa fa-reply fa-sm text-black-75"></i> Annuler Demande</a>
      ...
      <div class="col-lg-auto">
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Liste des demandes Heures Supp. All Staff</h6>			
          </div>
