  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverfact_processing.php",
			"language": {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-money"></i> Facturation T&eacute;l&eacute;phonique </h1>
			<?php 
				$exis = $mysqli->query("SELECT tel AS ID FROM user WHERE pseudo='$pseudo' ")->fetch_array();
				$phone = $exis['ID'];
				echo("<a href=\"factchardet.php?tel=".$phone."\" class=\"d-none d-sm-inline-block btn btn3 btn-sm btn-success shadow-sm\" title=\"Détails des Identifications\"><i class=\"fas fa-list fa-sm text-white-75\"></i> D&eacute;tails Identifications</a>");
				echo("<a href=\"factchar_archv.php?tel=".$phone."\" class=\"d-none d-sm-inline-block btn btn3 btn-sm btn-secondary shadow-sm\" title=\"Archives des détails\"><i class=\"fas fa-archive fa-sm text-white-75\"></i> Archives</a>");
			?>
		</div>
		<hr /> 
