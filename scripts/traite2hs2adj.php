...
include('connexion.php');
	...
	$sql2 = "UPDATE wfp_chd_djmcto SET cto_deb2='$datedep', cto_hdeb2='$saaa', cto_hfin2='$saar', cto_raison='$motif', cto_dapprover2='$alyom', cto_dure='$dure', cto_statut='CERTIFIE' WHERE cto_id='$id' ";
	...
	{
		echo("<span class=\"alert alert-danger\">Echec CERTIFICATION <br><br><center><a href=\"djoummahapprv.php\">retour</a></center></span>") ;
	}  
?>
