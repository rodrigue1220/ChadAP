...
<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-plus"></i> <i class="fas fa-fw fa-drivers-license"></i>  Driver</h1>
	...
	<div class="row">
      <div class="col-lg-8">
        <form class="form-horizontal" name="formulaire" action="addchauf2.php" method="post">
		  ...
		  <div class="form-group row">
			...
			<div class="col-sm-5">
			  <input type="text" class="form-control" id="tel" name="tel" required pattern="[0-9]{8}"/>
			</div>
		  </div>
