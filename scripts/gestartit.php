  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverartit_processing.php",
			"language": {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-laptop"></i> Articles Disponibles</h1>
			<a href="articaddit.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-secondary shadow-sm"><i class="fas fa-plus fa-sm text-black-75"></i> Nouvel Article</a>				
		</div> 
		<hr /> 
		  ...
		  <div class="col-lg-12">
			<div class="card shadow mb-4">
			  <div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Liste des Articles TEC</h6>
              </div>
