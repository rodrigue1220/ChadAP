  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverlogs_processing.php",
			"language": {
...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="logstktrzcum.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-warning shadow-sm"><i class="fas fa-calculator fa-sm text-white-75"></i> Cumul</a>
		...
		<?php 
			...
			{
				echo ("<a href=\"majlogstkreport.php\" class=\"d-none d-sm-inline-block btn btn3 btn-sm btn-secondary shadow-sm\"><i class=\"fas fa-spinner fa-sm text-white-75\"></i> Mettre &agrave; jour STK</a>");
	  ...
	  <div class="col-lg-auto">
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-cart-arrow-down"></i> In Stock</h6>
          </div>
		  
		  <?php
			
			$wakit	= date("dmY");
			include("exportlogstock.php");
			echo("<a href=\"WFP_Chad-ReportSTOCK-".$wakit.".csv\" class=\"d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm\"><i class=\"fa fa-download fa-sm text-black-75\"></i> T&eacute;l&eacute;charger REPORT IN STOCK en CSV au | <b>".date("d.m.Y")."</b> <i class=\"fa fa-download fa-sm text-black-75\"></i></a>");
		  ?>							     
