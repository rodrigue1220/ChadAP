...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fa fa-cutlery fa-fw"></i> Pause - Caf&eacute;</h1>
	<hr />
	<div class="row">
	  <div class="col-lg-12">
        <form class="form-horizontal" name="formulaire" action="add2pc.php" method="post" >
		  <div class="form-group row">
			<label class="control-label col-sm-3" for="artc">Article :</label>
			<div class="col-sm-5">
			  <input type="text" id="artc" name="artc" placeholder="Entrer la désignation" class="form-control"/>
			</div>
		  </div>
