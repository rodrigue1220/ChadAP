...
<style type="text/css"> .btn3{ width:180px; } </style>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-edit"></i> Demande HS n&deg; <font color="blue"><?php echo $_GET["id"];?></font></h1>
	  <a href="va2compenscto.php" class="d-none d-sm-inline-block btn btn3 btn-sm btn-info shadow-sm"><i class="fa fa-reply fa-sm text-black-75"></i> Retour</a>				     
    ...
    <div class="row">
	  ...
	  ?>
      <div class="col-lg-12">
        <form class="form-horizontal" name="formulaire" action="traite2hs2.php" method="post">
		  ...
		  <div class="form-group row">
			...
			<div class="col-sm-2">
			  <select class="form-control" id="heurd" name="heurd" required>
				<option><?php echo date("H", strtotime($result['cto_hdeb'])); ?></option><option> 00 </option><option> 01 </option><option> 02 </option>
			...
			<div class="col-sm-2">
			  <select class="form-control" id="mind" name="mind" required>
				<option><?php echo date("i", strtotime($result['cto_hdeb'])); ?></option>
		  ...
		  <div class="form-group row">
			...
			<div class="col-sm-2">
			  <select class="form-control" id="heurr" name="heurr" required>
				<option><?php echo date("H", strtotime($result['cto_hfin'])); ?></option><option> 00 </option><option> 01 </option><option> 02 </option>
				<option> 03 </option><option> 04 </option><option> 05 </option><option> 06 </option>
				<option> 07 </option><option> 08 </option><option> 09 </option><option> 10 </option>
				<option> 11 </option><option> 12 </option><option> 13 </option><option> 14 </option>
				<option> 15 </option><option> 16 </option><option> 17 </option><option> 18 </option>
			...
			<div class="col-sm-2">
			  <select class="form-control" id="minr" name="minr" required>
				<option><?php echo date("i", strtotime($result['cto_hfin'])); ?></option>
				<option> 00 </option><option> 05 </option><option> 10 </option><option> 15 </option>
				<option> 20 </option><option> 25 </option><option> 30 </option><option> 35 </option>
				<option> 40 </option><option> 45 </option><option> 50 </option><option> 55 </option>
			  </select>
		  ...
		  <div class="form-group row">
			<label class="control-label col-sm-3">Dur&eacute;e Pr&eacute;vue :</label>
			<div class="col-sm-4">
		  ...
		  <div class="form-group row">
			<div class="col-sm-offset-2 col-sm-12">
			  <button type="submit" class="btn btn3 btn-success"><i class="fa fa-calendar-check-o fa-fw"></i> Soumettre</button>
			</div>
		  </div>
		</form>
      </div>
