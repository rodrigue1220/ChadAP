...
*/
	...
	if ($id == "")
	{
		header('Location:logstkreport.php');
	}
    ...
    <div class="row">
		<?php	
			...
			echo("<table class=\"table table-striped table-bordered table-hover\"><tbody>
				...
				<tr><th>Warehouse</th><td>".$result['logs_wh']."</td></tr>
				<tr><th>Mat. Desc.</th><td>".$result['logs_matdesc']."</td></tr>
				<tr><th>Batch</th><td>".$result['logs_batch']."</td></tr>
				<tr><th>WBS</th><td>".$result['logs_wbs']."</td></tr>
				<tr><th>Grant Code</th><td>".$result['logs_grantnum']."</td></tr>
				<tr><th>Grant Desc.</th><td>".$result['logs_grantdesc']."</td></tr>
				<tr><th>BBD</th><td>".$result['logs_sledbbd']."</td></tr>
				<tr><th>Tot. Stock</th><td>".$result['logs_total']."</td></tr>
				<tr><th>TDD Grant</th><td>".$result['logs_tddgrant']."</td></tr>");
