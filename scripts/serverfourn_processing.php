...
$table = <<<EOT
 (
	SELECT j.vars_id, j.vars_item, j.vars_nbr, j.vars_sens, j.vars_ref, j.vars_date, j.vars_type, p.catart_code, p.catart_nom 
...
$columns = array(
	...
	array( 'db' => 'vars_sens', 'dt' => 4 ),
	array( 'db' => 'vars_date', 'dt' => 5 )
);
