  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverfactchararch_processing.php",
			"language": {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-tasks"></i> D&eacute;tails des Appels T&eacute;l&eacute;phoniques et SMS (Archives)</h1>
			<?php echo("<a href=\"factchar_archv.php?tel=".$phone."\" class=\"d-none d-sm-inline-block btn btn3 btn-sm btn-primary shadow-sm\" title=\"Mes Factures\"><i class=\"fas fa-newspaper-o fa-sm text-white-75\"></i> MES FACTURES</a>"); ?>
		</div> 
		<hr /> 
	...
	<div class="row">
	  <div class="col-lg-12">
		<div class="card shadow mb-4">
		  ...
		  <?php echo ("<a href=\"Details_Billing_Archv".$phone."-".$wakit.".csv\" class=\"d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm\"><i class=\"fa fa-download fa-sm text-black-75\"></i> T&eacute;l&eacute;charger D&eacute;tails | ".$phone." <i class=\"fa fa-download fa-sm text-black-75\"></i></a>"); ?>								     
