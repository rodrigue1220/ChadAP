    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <center>
			<img src="../img/super.png" alt="Felicitations">
			<br /><div class="alert alert-success"><strong>Le mot de passe a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s!!!!!!</strong>
			</div> 
		  </center>
