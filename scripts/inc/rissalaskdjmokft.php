...
try {
	...
	$body	.= 'Votre Demande de Cong&eacute;s cr&eacute;&eacute;e a &eacute;t&eacute; APPROUVEE / OIC : <br /><br />';
	...
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demande sur Self Service: <b>'.$resultz['lv_rr'].'</b><br />';
	...
	$mail->Subject  = "Demande Conges APPROUVEE";
