<?php
	...
	if ($type == "AL")
	{
		$sql2 = "UPDATE wfp_chd_rqdjoummah SET lv_aldeb='$wakit', lv_alfin='$ret', lv_alnbr='$nbjour' 
				WHERE lv_nopers='$nopers' AND lv_id='$identif' ";
	}
	else if ($type == "CTO")
	{
		$sql2 = "UPDATE wfp_chd_rqdjoummah SET lv_ctodeb='$wakit', lv_ctofin='$ret', lv_ctonbr='$nbjour' 
				WHERE lv_nopers='$nopers' AND lv_id='$identif' ";
	}	
