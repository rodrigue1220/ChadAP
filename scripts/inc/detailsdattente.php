<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Demandes de SDR en Attente</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
						...
						if($exis['ID'] != 0)
						{
							...
							while( $result = $requete->fetch_assoc()  )
							{
								...
								echo("<td><button type=\"button\" class=\"btn btn-primary btn-circle\" onclick=\"document.location='detailreqstsdr.php?id=".$result['reqsdr_id']."'\" title=\"DETAILS\"><i class=\"fa fa-list\"></i></button></td>
									<td><button type=\"button\" class=\"btn btn-success btn-circle\" onclick=\"document.location='validasksdr.php?id=".$result['reqsdr_id']."'\" title=\"VALIDER\"><i class=\"fa fa-check\"></i></button></td>
