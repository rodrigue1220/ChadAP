...
try {
	...
	$body	.= 'Votre mot de passe a bien &eacute;t&eacute; REINITIALISE ! <br /><br />';
	$body	.= '<table><tr><td class="ligne">Login / Pseudo </td><td class="ligne"><b>'.$id.'</b></td></tr>';
	...
	header("D:/Apps/www/scripts/modif1user3.php");
