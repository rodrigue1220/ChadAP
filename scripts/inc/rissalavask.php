...
try {
	...
	$body	.= 'Votre Demande de Transport cr&eacute;&eacute;e a &eacute;t&eacute; APPROUVEE : <br /><br />';
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Passager (s) : <b>'.$passager.'</b><br />';
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Motif : <b>'.$motif.'</b><br />';
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Destination : <b>'.$desti.'</b><br />';
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile : <b>'.$vehicle.'</b><br />';
	$body	.= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chauffeur : <b>'.$chauf.'</b><br /><br />';
	$body	.= 'Merci de prendre contact directement avec le Chauffeur<br /><br />';
	...
	$mail->Subject  = "Demande de Transport APPROUVEE";
