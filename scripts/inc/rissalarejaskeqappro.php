...
try {
	...
	$body	.= 'Votre Demande d\'&eacute;quipement cr&eacute;&eacute;e a &eacute;t&eacute; REJETEE par Admin Appro / STOCK : <br /><br />';
	...
	$body	.= '<tr><td class="ligne">Approuv&eacute;e (OIC/ICT) par </td><td class="ligne"><b>'.$oicit.'</b></td></tr>';
