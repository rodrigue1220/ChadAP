...
try {
	...
	$body	.= 'Votre Demande d\'&eacute;quipement cr&eacute;&eacute;e a &eacute;t&eacute; REJETEE par le SERVICEDESK / IT : <br /><br />';
	...
	$body	.= '<tr><td class="ligne">Raison </td><td class="ligne"><b>'.$comm.'</b></td></tr></table><br />';
