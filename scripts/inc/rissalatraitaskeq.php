...
try {
	...
	$body	.= 'Votre Demande d\'&eacute;quipement cr&eacute;&eacute;e a &eacute;t&eacute; TRAITEE : <br /><br />';
	...
	//$body	.= '<tr><td class="ligne">Quantit&eacute; approuv&eacute;e </td><td class="ligne"><b>'.$nbrd.'</b></td></tr></table><br />';
	$body	.= 'Merci de prendre contact avec Chad IT Service Desk pour la suite<br /><br />';
	...
	$mail->Subject  = "Demande Equipement TRAITEE";
