...
try {
	...
	$body	.= 'Votre Demande de fourniture cr&eacute;&eacute;e a &eacute;t&eacute; REJETEE par Admin Appro / STOCK : <br /><br />';
	$body	.= '<table><tr><td class="ligne">Item </td><td class="ligne"><b>'.$item.'</b></td></tr>';
	...
	$body	.= '<tr><td class="ligne">Approuv&eacute;e (OIC/ADMIN) par </td><td class="ligne"><b>'.$oicit.'</b></td></tr>';
	...
	$mail->AddAddress($to);
	$mail->AddCC($messagit);
	$mail->Subject  = "Demande Fourniture REJETEE";
