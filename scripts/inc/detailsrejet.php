...
?>  
  <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Demandes de Transport Rejet&eacute;es</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								$i=1;
								$exis = $mysqli->query("SELECT reqst_id AS ID FROM wfp_chd_request WHERE reqst_state='REJET' AND reqst_sens='$sofo'")->fetch_array();
						
								if($exis['ID'] != 0)
								{
									$sql = "SELECT * FROM wfp_chd_request WHERE reqst_state='REJET' AND reqst_sens='$sofo'" ;
									...
									while( $result = $requete->fetch_assoc()  )
									{
										...
										echo("<td><button type=\"button\" class=\"btn btn-success btn-circle\" onclick=\"document.location='validask.php?id=".$result['reqst_id']."'\" title=\"VALIDER\"><i class=\"fa fa-check\"></i></button></td>
