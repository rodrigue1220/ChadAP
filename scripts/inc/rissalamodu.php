...
try {
	...
	$body	.= 'Votre mot de passe a &eacute;t&eacute; REINITIALISE ! <br /><br />';
	$body	.= '<table><tr><td class="ligne">Login / Pseudo </td><td class="ligne"><b>'.$loguser.'</b></td></tr>';
	$body	.= '<tr><td class="ligne">Nouveau Mot de passe </td><td class="ligne"><b>'.$mdb.'</b></td></tr></table><br /><br />';
	...
	$mail->Subject  = "REINITIALISATION PASSWORD";
	...
	{
		include("D:/Apps/www/scripts/userlist.php");
	}
	else
	{
		include("D:/Apps/www/scripts/logout.php");
	}
