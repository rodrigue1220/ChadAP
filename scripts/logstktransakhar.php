  ...
  <script>
	$(document).ready(function() {
		$('#example').DataTable( {
			...
			"serverSide": true,
			"pageLength": 3,
			"ajax": "serverlogtakh_processing.php",
			"language": {
	  ...
	  <div class="col-lg-auto">
		<div class="card shadow mb-4">
          <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-success"><i class="fa fa-fw fa-exchange"></i> In Transit OTHER | <a href="logstktransit.php">TDCO</a></h6>
          </div>
		  
		  <?php
			
			$wakit	= date("dmY");
			include("exportlogtransitakh.php");
			echo("<a href=\"WFP_Chad-ReportTRANSIT-OTHER-".$wakit.".csv\" class=\"d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm\"><i class=\"fa fa-download fa-sm text-black-75\"></i> T&eacute;l&eacute;charger REPORT IN TRANSIT en CSV au | <b>".date("d.m.Y")."</b> <i class=\"fa fa-download fa-sm text-black-75\"></i></a>");
		  ?>							     
