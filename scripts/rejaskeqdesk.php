...
<style type="text/css"> .btn3{ width:180px; } </style>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-remove"></i> Rejet SERVICEDESK / ICT</h1>
	...
	<div class="row">
	  <div class="col-lg-8">
		...
		?>
          <form name="formulaire" action="rejaskeqdesk2.php" method="post">
			...
			<div class="form-group row">
  			  <label class="control-label col-sm-4" for="comm">Commentaires :</label>
			  <div class="col-sm-8">
				<textarea id="comm" name="comm" placeholder="Saisir vos remarques" class="form-control"></textarea>
			  </div>
			</div>			
